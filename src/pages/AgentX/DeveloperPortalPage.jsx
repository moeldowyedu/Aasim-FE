...
const DeveloperPortalPage = () => {
  ...
  const getMethodColor = (method) => {
    const colors = {
      GET: 'bg-blue-900/20 text-blue-300',
      POST: 'bg-green-900/20 text-green-300',
      PUT: 'bg-yellow-900/20 text-yellow-300',
  ...
  const codeExamples = {
    python: `# Install the Obsolio SDK
# pip install obsolio-python

from obsolio import Obsolio

# Initialize client
client = Obsolio(api_key='your-api-key-here')
...
print(f"Output: {result.output}")`,
    ...
    javascript: `// Install the Obsolio SDK
// npm install @obsolio/sdk

const Obsolio = require('@obsolio/sdk');

// Initialize client
const client = new Obsolio({
...
curl -X POST https://api.obsolio.ai/v1/agents/run \\
...
# Get run status
curl -X GET https://api.obsolio.ai/v1/runs/run-456 \\
  -H "Authorization: Bearer your-api-key-here"`
  };
                        ...
                        <div className="flex-grow">
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            {webhook.events.map((event, idx) => (
                              <span
                                key={idx}
                                className="px-3 py-1 bg-blue-900/20 text-blue-300 text-xs rounded-lg font-medium"
                              >
                                {event}
                              </span>
                            ))}
                  ...
                  {[
                    {
                      name: 'Python',
                      icon: '🐍',
                      install: 'pip install obsolio-python',
                      docs: 'https://docs.obsolio.ai/python',
                      color: 'from-blue-500 to-blue-600'
                    },
                    {
                      name: 'JavaScript / Node.js',
                      icon: '📦',
                      install: 'npm install @obsolio/sdk',
                      docs: 'https://docs.obsolio.ai/javascript',
                      color: 'from-yellow-500 to-yellow-600'
                    },
                    {
                      name: 'Java',
                      icon: '☕',
                      install: 'maven: com.obsolio:obsolio-java',
                      docs: 'https://docs.obsolio.ai/java',
                      color: 'from-red-500 to-red-600'
                    },
                    {
                      name: 'Ruby',
                      icon: '💎',
                      install: 'gem install obsolio',
                      docs: 'https://docs.obsolio.ai/ruby',
                      color: 'from-pink-500 to-pink-600'
                    },
                    {
                      name: 'PHP',
                      icon: '🐘',
                      install: 'composer require obsolio/sdk',
                      docs: 'https://docs.obsolio.ai/php',
                      color: 'from-purple-500 to-purple-600'
                    },
                    {
                      name: 'Go',
                      icon: '🔵',
                      install: 'go get github.com/obsolio/obsolio-go',
                      docs: 'https://docs.obsolio.ai/go',
                    ...
                    <div key={index} className="bg-white shadow-sm border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-shadow">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button className="px-4 py-2 bg-blue-900/20 text-blue-300 rounded-lg text-sm font-semibold hover:bg-blue-200 flex items-center gap-2">
