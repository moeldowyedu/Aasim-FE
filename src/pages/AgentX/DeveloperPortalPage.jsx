      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-3xl font-bold text-gray-900">186.5K</div>
          ...
          <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-3xl font-bold text-gray-900">6.3K</div>
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
          ...
          <div className="p-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-6 text-sm">
                        <div>
                          <div className="text-gray-600 mb-1">Requests per minute</div>
                          <div className="text-2xl font-bold text-gray-900">1,000</div>
                        </div>
                        <div>
                          <div className="text-gray-600 mb-1">Concurrent requests</div>
                          <div className="text-2xl font-bold text-gray-900">100</div>
                        </div>
                        <div>
                          <div className="text-gray-600 mb-1">Monthly quota</div>
            ...
            {activeTab === 'webhooks' && (
              <div className="space-y-6">
                ...
                <div className="glass-card rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-4">Available Events</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          <code className="text-sm font-semibold text-gray-900">{item.event}</code>
                  ...
                  {webhooks.map((webhook) => (
                    <div key={webhook.id} className="glass-card rounded-xl p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-grow">
                          <div className="flex items-center gap-3 mb-2">
                            <code className="text-lg font-bold text-gray-900">{webhook.url}</code>
                            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700 border border-green-200">
                              Active
                            </span>
                          </div>
            ...
            {activeTab === 'sdk' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Official SDKs & Libraries</h2>
            ...
            {activeTab === 'code-examples' && (
              <div className="space-y-6">
                ...
                {/* API Base URL */}
                <div className="glass-card rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3">Base URL</h3>
            ...
            {activeTab === 'activity' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Recent API Activity</h2>
                  <p className="text-gray-600 mb-6">
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Endpoint</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Status</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Response Time</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">API Key</th>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {recentActivity.map((activity) => (
                          <tr key={activity.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <code className="text-sm text-gray-900">{activity.endpoint}</code>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm text-gray-900">{activity.responseTime}ms</span>
                              </div>
                            </td>
