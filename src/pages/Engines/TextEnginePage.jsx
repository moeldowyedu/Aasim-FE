  ...
  const handleAnalyze = async () => {
    ...
    setTimeout(() => {
      setResults({
        sentiment: 'Positive',
        sentimentScore: 0.87,
        entities: ['Obsolio AI', 'Precision Engine', 'Machine Learning'],
    ...
    <MainLayout>
      <div className="py-6 space-y-8">
        ...
        <div className="flex items-start gap-6">
          <div
            className="w-20 h-20 rounded-xl flex items-center justify-center text-secondary-900 shadow-lg"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-secondary-600 bg-white p-3 rounded border border-gray-200">
                        {results.summary}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card padding="md" className="bg-gradient-to-br from-cyan-900/10 to-cyan-900/20 border-cyan-900/30">
